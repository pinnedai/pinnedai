...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js report --help` exits 0"
...
//   pinned retire auto-20260605-cli-exits-zero-node-apps-cli-dist-cli-js-report-help-il5f4m --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js report --help";
const ARGV = ["node","./apps/cli/dist/cli.js","report","--help"];
const ORIGINAL_PR = "auto-20260605";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js report --help` exits 0";
const TEST_FILENAME = "auto-20260605-cli-exits-zero-node-apps-cli-dist-cli-js-report-help-il5f4m.test.ts";
