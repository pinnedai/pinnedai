...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js confirm --help` exits 0"
...
//   pinned retire auto-20260605-cli-exits-zero-node-apps-cli-dist-cli-js-confirm-help-icr4q2 --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js confirm --help";
const ARGV = ["node","./apps/cli/dist/cli.js","confirm","--help"];
const ORIGINAL_PR = "auto-20260605";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js confirm --help` exits 0";
const TEST_FILENAME = "auto-20260605-cli-exits-zero-node-apps-cli-dist-cli-js-confirm-help-icr4q2.test.ts";
