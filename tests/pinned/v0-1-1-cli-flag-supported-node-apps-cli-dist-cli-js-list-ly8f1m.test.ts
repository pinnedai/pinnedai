...
// Original PR claim: "`node ./apps/cli/dist/cli.js list` supports `--include-retired`"
// Pinned to fail if this is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire v0-1-1-cli-flag-supported-node-apps-cli-dist-cli-js-list-ly8f1m --reason="..."

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js list";
const ARGV = ["node","./apps/cli/dist/cli.js","list"];
const FLAG = "--include-retired";
const ORIGINAL_PR = "v0-1-1";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js list` supports `--include-retired`";
const TEST_FILENAME = "v0-1-1-cli-flag-supported-node-apps-cli-dist-cli-js-list-ly8f1m.test.ts";
