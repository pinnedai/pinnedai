...
// Original PR claim: "`node ./apps/cli/dist/cli.js generate` supports `--dry-run`"
// Pinned to fail if this is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire v0-1-1-cli-flag-supported-node-apps-cli-dist-cli-js-generate-3nztls --reason="..."

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js generate";
const ARGV = ["node","./apps/cli/dist/cli.js","generate"];
const FLAG = "--dry-run";
const ORIGINAL_PR = "v0-1-1";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js generate` supports `--dry-run`";
const TEST_FILENAME = "v0-1-1-cli-flag-supported-node-apps-cli-dist-cli-js-generate-3nztls.test.ts";
