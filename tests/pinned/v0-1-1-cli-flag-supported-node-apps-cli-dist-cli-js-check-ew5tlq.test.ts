...
// Original PR claim: "`node ./apps/cli/dist/cli.js check` supports `--json`"
// Pinned to fail if this is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire v0-1-1-cli-flag-supported-node-apps-cli-dist-cli-js-check-ew5tlq --reason="..."

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js check";
const ARGV = ["node","./apps/cli/dist/cli.js","check"];
const FLAG = "--json";
const ORIGINAL_PR = "v0-1-1";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js check` supports `--json`";
const TEST_FILENAME = "v0-1-1-cli-flag-supported-node-apps-cli-dist-cli-js-check-ew5tlq.test.ts";
