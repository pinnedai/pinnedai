...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js scan --help` exits 0"
...
//   pinned retire auto-20260521-cli-exits-zero-node-apps-cli-dist-cli-js-scan-help-s20m5j --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js scan --help";
const ARGV = ["node","./apps/cli/dist/cli.js","scan","--help"];
const ORIGINAL_PR = "auto-20260521";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js scan --help` exits 0";
const TEST_FILENAME = "auto-20260521-cli-exits-zero-node-apps-cli-dist-cli-js-scan-help-s20m5j.test.ts";
