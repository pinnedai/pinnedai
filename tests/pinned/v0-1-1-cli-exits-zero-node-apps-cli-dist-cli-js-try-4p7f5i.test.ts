...
// Original PR claim: "`node ./apps/cli/dist/cli.js try` exits 0"
// Pinned to fail if this is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire v0-1-1-cli-exits-zero-node-apps-cli-dist-cli-js-try-4p7f5i --reason="..."

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js try";
const ARGV = ["node","./apps/cli/dist/cli.js","try"];
const ORIGINAL_PR = "v0-1-1";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js try` exits 0";
const TEST_FILENAME = "v0-1-1-cli-exits-zero-node-apps-cli-dist-cli-js-try-4p7f5i.test.ts";
