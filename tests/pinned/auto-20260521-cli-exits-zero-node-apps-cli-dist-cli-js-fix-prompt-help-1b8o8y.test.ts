...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js fix-prompt --help` exits 0"
...
//   pinned retire auto-20260521-cli-exits-zero-node-apps-cli-dist-cli-js-fix-prompt-help-1b8o8y --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js fix-prompt --help";
const ARGV = ["node","./apps/cli/dist/cli.js","fix-prompt","--help"];
const ORIGINAL_PR = "auto-20260521";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js fix-prompt --help` exits 0";
const TEST_FILENAME = "auto-20260521-cli-exits-zero-node-apps-cli-dist-cli-js-fix-prompt-help-1b8o8y.test.ts";
