...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js add-browser --help` exits 0"
...
//   pinned retire auto-20260603-cli-exits-zero-node-apps-cli-dist-cli-js-add-browser-help-1e77ol --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js add-browser --help";
const ARGV = ["node","./apps/cli/dist/cli.js","add-browser","--help"];
const ORIGINAL_PR = "auto-20260603";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js add-browser --help` exits 0";
const TEST_FILENAME = "auto-20260603-cli-exits-zero-node-apps-cli-dist-cli-js-add-browser-help-1e77ol.test.ts";
