...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js audit-learned --help` exits 0"
...
//   pinned retire auto-20260602-cli-exits-zero-node-apps-cli-dist-cli-js-audit-learned-help-uhg37x --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js audit-learned --help";
const ARGV = ["node","./apps/cli/dist/cli.js","audit-learned","--help"];
const ORIGINAL_PR = "auto-20260602";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js audit-learned --help` exits 0";
const TEST_FILENAME = "auto-20260602-cli-exits-zero-node-apps-cli-dist-cli-js-audit-learned-help-uhg37x.test.ts";
