...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js scan-pr --help` exits 0"
...
//   pinned retire auto-20260522-cli-exits-zero-node-apps-cli-dist-cli-js-scan-pr-help-r9mk4o --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js scan-pr --help";
const ARGV = ["node","./apps/cli/dist/cli.js","scan-pr","--help"];
const ORIGINAL_PR = "auto-20260522";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js scan-pr --help` exits 0";
const TEST_FILENAME = "auto-20260522-cli-exits-zero-node-apps-cli-dist-cli-js-scan-pr-help-r9mk4o.test.ts";
