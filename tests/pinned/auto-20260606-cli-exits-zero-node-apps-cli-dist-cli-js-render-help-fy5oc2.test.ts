...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js render --help` exits 0"
...
//   pinned retire auto-20260606-cli-exits-zero-node-apps-cli-dist-cli-js-render-help-fy5oc2 --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js render --help";
const ARGV = ["node","./apps/cli/dist/cli.js","render","--help"];
const ORIGINAL_PR = "auto-20260606";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js render --help` exits 0";
const TEST_FILENAME = "auto-20260606-cli-exits-zero-node-apps-cli-dist-cli-js-render-help-fy5oc2.test.ts";
