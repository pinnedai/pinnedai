...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js review --help` exits 0"
...
//   pinned retire auto-20260522-cli-exits-zero-node-apps-cli-dist-cli-js-review-help-rcmt2a --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js review --help";
const ARGV = ["node","./apps/cli/dist/cli.js","review","--help"];
const ORIGINAL_PR = "auto-20260522";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js review --help` exits 0";
const TEST_FILENAME = "auto-20260522-cli-exits-zero-node-apps-cli-dist-cli-js-review-help-rcmt2a.test.ts";
