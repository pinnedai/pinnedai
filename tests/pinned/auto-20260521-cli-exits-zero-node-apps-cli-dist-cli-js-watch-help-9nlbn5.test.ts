...
// ═══════════════════════════════════════════════════════════════
// Original PR claim: "`node ./apps/cli/dist/cli.js watch --help` exits 0"
...
//   pinned retire auto-20260521-cli-exits-zero-node-apps-cli-dist-cli-js-watch-help-9nlbn5 --reason="..."
// ═══════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { spawnSync } from "node:child_process";

const COMMAND = "node ./apps/cli/dist/cli.js watch --help";
const ARGV = ["node","./apps/cli/dist/cli.js","watch","--help"];
const ORIGINAL_PR = "auto-20260521";
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js watch --help` exits 0";
const TEST_FILENAME = "auto-20260521-cli-exits-zero-node-apps-cli-dist-cli-js-watch-help-9nlbn5.test.ts";
