...
// Original PR claim: "`node ./apps/cli/dist/cli.js --version` exits 0"
// Pinned to fail if this is ever regressed.
//
// Retire when no longer applicable:
//   pinned retire v0-1-1-cli-exits-zero-node-apps-cli-dist-cli-js-version-pnybqr --reason="..."
...
const ORIGINAL_CLAIM = "`node ./apps/cli/dist/cli.js --version` exits 0";
const TEST_FILENAME = "v0-1-1-cli-exits-zero-node-apps-cli-dist-cli-js-version-pnybqr.test.ts";
